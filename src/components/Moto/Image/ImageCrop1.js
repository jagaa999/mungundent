...
const ImageCrop1 = ({ onChange, imagemainFileList }) => {
  ...
  return (
    ...
    >
      <Upload
        action={`https://api.cloudinary.com/v1_1/motomn/image/upload?upload_preset=moto-member&folder=members/${memberContext.state.memberUID}`}
