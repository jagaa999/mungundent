...
const UploadPictureMoto = (props) => {
  ...
  const uploadToCloudinary = (e) => {
    ...
    formData.append("upload_preset", "motocar");
    formData.append("file", myFile);
    formData.append("folder", "motocar/" + memberContext.state.memberUID);
    ...
    axios
      .post("https://api.cloudinary.com/v1_1/dzih5nqhg/image/upload", formData)
      .then((res) => {
        ...
        const originalFileURL =
          "https://res.cloudinary.com/dzih5nqhg/image/upload/";
        const thumbnailFileURL =
          "https://res.cloudinary.com/dzih5nqhg/image/upload/c_thumb,w_200,g_face/";
